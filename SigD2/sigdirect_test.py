...
def prep_data(dataset_name,counter):
    ...
    test_name  = 'datasets_new_ensemble_boosting/' + dataset_name + '_val'+ str(counter) +'.txt'    
...
def test_uci():
    ...
    for index in range(start_index, final_index +1):
        ...
        train_filename  =   'datasets_new_ensemble_boosting/' + dataset_name + '_val'+ str(counter) +'.txt'
        ...
        train_filename  =   'datasets_new_ensemble_boosting/' + dataset_name + '_train'+ str(counter) +'.txt'
        ...
        generated_c, final_c = clf.fit(X, y, X_val,y_val)
        ...
        test_filename  =   'datasets_new_ensemble_boosting/' + dataset_name + '_test'+ str(counter) +'.txt'
