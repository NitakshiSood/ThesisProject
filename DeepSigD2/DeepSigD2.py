...
if __name__ == "__main__":
    ...
    fileName='penDigits'#'soybean_nomissingfile'#'letRecog'#'adult_arff_nomissingval'#'ionosphere'#'yeast_csv_changed'#'adult_arff_nomissingval'#'adult_myversion2_nomissingdata'#'adult_myversion2_nomissingdata'#'ionosphere'#'penDigits'#'mushroomchanged'
