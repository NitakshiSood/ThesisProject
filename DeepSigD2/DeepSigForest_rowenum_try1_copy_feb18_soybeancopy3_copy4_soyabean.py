...
if __name__ == "__main__":
    ...
    fileName='soybean_nomissingfile'#'adult_arff_nomissingval'#'ionosphere'#'yeast_csv_changed'#'adult_arff_nomissingval'#'adult_myversion2_nomissingdata'#'adult_myversion2_nomissingdata'#'ionosphere'#'penDigits'#'mushroomchanged'
    ...
    for num_run in range(1,num_runs+1):
        ...
        #x_train_subset=[]
        #Xtest_sub=[]
        windowsize_list=[10,11,12]#[7,8,9]#[14,15,16]#[5,6,7]#[8,9,10]#[8,9,10]#[5,6,7]#[8,9,10] # this code works only for three types of window sizes
        ...
        n=8 # here n is the number of random samples you generate. most probably check again
