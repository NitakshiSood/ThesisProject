...
if __name__ == "__main__":
    ...
    fileName='letRecog'#'adult_myversion2_nomissingdata'#'adult_myversion2_nomissingdata'#'ionosphere'#'penDigits'#'mushroomchanged'
    ...
    for num_run in range(1,num_runs+1):
        ...
        #x_train_subset=[]
        #Xtest_sub=[]
        windowsize_list=[6,7,8]#[14,15,16]#[5,6,7]#[14,15,16]#[5,6,7]#[8,9,10]#[8,9,10]#[5,6,7]#[8,9,10] # this code works only for three types of window sizes
