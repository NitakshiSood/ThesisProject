...
class AssociativeClassifier:
    ...
    def fit(self, **kwargs):
        ...
        #print(type(self._generated_rules))
        #print(type(self._generated_rules[0]))
    ...
    def _prune_rules(self):
        ...
        #print("yahan pr kya hai? : ",len(self._generated_rules))
        if len(self._generated_rules)==0:
            #print("rules_dict: ")
            #print(rules_dict)
            #print(shcbs)
            return        
    ...
    def pruneripper(self):
        ...
        while _rule_dict and _transactions: # try using this for sorting with confidence values
            ...
            #    break
            print("conf: ",conf)
            if not conf or conf < 0.30: #or conf < 0.20: #or conf < 0.0: #0.5
                break            
    ...
    def _predict_instance(self, instance, hrs=None):
        ...
        if type(instance) in [pd.core.series.Series, pd.core.frame.DataFrame]:
            #instance =  instance[instance==1].index.astype(int) my change
