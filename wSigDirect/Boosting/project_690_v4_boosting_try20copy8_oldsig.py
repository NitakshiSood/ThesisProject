...
#17sept- this code can be used for boosting oldsig on the acboost self code.
#oct 29 update- trying to make sigdirect more weak. and then boost on that .should do this on boosting code and not here.
...
if __name__ == "__main__":
    ...
    fileName_list=['train_mnist_discritized_transformed_2_ts1'] #led7_myversion #led7_myversion
    for fileName in fileName_list:
        ...
        for num_run in range(1,num_runs+1):
            ...
            sample_weight=1/(count_unique) #check this out
            ...
            #weight_dict = dict.fromkeys(feature_values,X_train.shape[0] ) #set this values
