...
#finally using after changes on 10th sept.
import random
import numpy as np
...
def boosting_func(predictions,X_train, X_test_updated, y_train, y_test, sample_weight,weight_dict,X_test):
    ...
    #set this
    n_classes_=3 #FOR IRIS ONLY #set this
...
#http://www.thushv.com/boosting/samme-a-multiclass-boosting-algorithm/
#https://web.stanford.edu/~hastie/Papers/samme.pdf
#http://users.stat.umn.edu/~zouxx019/Papers/samme.pdf
def unique(list1): 
    x = np.array(list1) 
    #print(np.unique(x)) 
...
if __name__ == "__main__":
    ...
    fileName_list=['wine'] #led7_myversion #led7_myversion
