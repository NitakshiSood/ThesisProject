...
def main(dataset_name):
    ...
    for fold_number in range(1,test_count+1):
        ...
        input_name  = 'datasets_new/' + dataset_name + '_train'+ str(fold_number)+'.txt'
        test_name   = 'datasets_new/' + dataset_name + '_test' + str(fold_number) + '.txt'
        
        print(fold_number)
        accs,predictions = run_test(str(fold_number),input_name,test_name)
        acc_acc.append(accs)
        print('\n\n')
        sys.stdout.flush()
