...
if __name__ == "__main__":
    ...
    fileName='adult_arff_nomissingval'#'ionosphere'#cylband_nomissingdata5'#'penDigits'
    #'cylband_nomissingdata5'#'ionosphere'#soybean_nomissingfile'#'ionosphere'#soybean_nomissingfile'
    #adultnew'#ionosphere'#adult'#'edited_WATT_Data7_March14_2018_preprocessed_NumNomConvert_3divnorm' #WCB_V5_norm _copy
